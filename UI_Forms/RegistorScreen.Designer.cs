namespace UI_Forms
{
    partial class RegistorScreen
    {
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(RegistorScreen));
            panel1 = new Panel();
            btnKapat = new Button();
            label1 = new Label();
            pictureBox1 = new PictureBox();
            pnlKullanıcı = new Panel();
            label11 = new Label();
            ...
            pnlKullanıcıBilgi.SuspendLayout();
            ...
            // pnlKullanıcı
            // 
            pnlKullanıcı.BackColor = SystemColors.ControlLight;
            pnlKullanıcı.Controls.Add(label11);
            pnlKullanıcı.Controls.Add(txtIpucu);
            pnlKullanıcı.Controls.Add(pictureBox5);
            pnlKullanıcı.Controls.Add(pictureBox4);
            pnlKullanıcı.Controls.Add(pictureBox3);
            pnlKullanıcı.Controls.Add(pictureBox2);
            pnlKullanıcı.Controls.Add(pictureBox19);
            pnlKullanıcı.Controls.Add(pictureBox20);
            pnlKullanıcı.Controls.Add(chbSifreGöster);
            pnlKullanıcı.Controls.Add(txtTekrarSifre);
            pnlKullanıcı.Controls.Add(label6);
            pnlKullanıcı.Controls.Add(txtSifre);
            pnlKullanıcı.Controls.Add(label5);
            pnlKullanıcı.Controls.Add(txtEMail);
            pnlKullanıcı.Controls.Add(label4);
            pnlKullanıcı.Controls.Add(txtSoyad);
            pnlKullanıcı.Controls.Add(label3);
            ...
            txtIpucu.Size = new Size(160, 26);
            txtIpucu.TabIndex = 24;
            // 
            // pictureBox5
            // 
            ...
            chbSifreGöster.Text = "Şifreyi Göster";
            chbSifreGöster.UseVisualStyleBackColor = true;
            chbSifreGöster.CheckedChanged += chbSifreGöster_CheckedChanged;
            // 
            // txtTekrarSifre
            // 
            ...
            txtTekrarSifre.PlaceholderText = "Sifrenizi Tekrar Giriniz";
            txtTekrarSifre.Size = new Size(160, 26);
            txtTekrarSifre.TabIndex = 14;
            // 
            // label6
            // 
            ...
            label6.TabIndex = 13;
            label6.Text = "Şifrenizi Tekrar Ediniz";
            // 
            // txtSifre
            // 
            ...
            txtSifre.Size = new Size(160, 26);
            txtSifre.TabIndex = 11;
            toolTip1.SetToolTip(txtSifre, "Şifreniz en az 8 karakter olmak zorundadır.İçerisinde en az 1 büyük harf,1 küçük harf, 1 özel karakter bulundurmalıdır.");
            // 
            // label5
            // 
            ...
            // pnlKullanıcıBilgi
            // 
            pnlKullanıcıBilgi.BackColor = SystemColors.ControlLight;
            pnlKullanıcıBilgi.Controls.Add(nudKilo);
            pnlKullanıcıBilgi.Controls.Add(nudBoy);
            pnlKullanıcıBilgi.Controls.Add(pictureBox8);
            pnlKullanıcıBilgi.Controls.Add(pictureBox7);
            pnlKullanıcıBilgi.Controls.Add(pictureBox6);
            pnlKullanıcıBilgi.Controls.Add(lnkHesapVarMı);
            pnlKullanıcıBilgi.Controls.Add(btnKayıt);
            pnlKullanıcıBilgi.Controls.Add(label10);
            pnlKullanıcıBilgi.Controls.Add(label9);
            pnlKullanıcıBilgi.Controls.Add(dtpDogumTarihi);
            pnlKullanıcıBilgi.Controls.Add(label8);
            pnlKullanıcıBilgi.Controls.Add(rbErkek);
            ...
            nudKilo.Size = new Size(131, 23);
            nudKilo.TabIndex = 18;
            nudKilo.Value = new decimal(new int[] { 20, 0, 0, 0 });
            // 
            // nudBoy
            // 
            ...
            nudBoy.Name = "nudBoy";
            nudBoy.Size = new Size(131, 23);
            nudBoy.TabIndex = 17;
            nudBoy.Value = new decimal(new int[] { 50, 0, 0, 0 });
            // 
            // pictureBox8
            // 
            ...
            lnkHesapVarMı.TabStop = true;
            lnkHesapVarMı.Text = "Zaten Hesabınız Var Mı ?";
            lnkHesapVarMı.LinkClicked += lnkHesapVarMı_LinkClicked;
            // 
            // btnKayıt
            // 
            ...
            dtpDogumTarihi.Value = new DateTime(2024, 3, 23, 0, 0, 0, 0);
            // 
            // label8
            // 
            ...
            pnlKullanıcı.ResumeLayout(false);
            pnlKullanıcı.PerformLayout();
            ...
            pnlKullanıcıBilgi.ResumeLayout(false);
            pnlKullanıcıBilgi.PerformLayout();
        ...
        private CheckBox chbSifreGöster;
        private Panel pnlKullanıcıBilgi;
        ...
        private LinkLabel lnkHesapVarMı;
